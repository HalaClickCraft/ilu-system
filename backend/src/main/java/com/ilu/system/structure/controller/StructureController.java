...
public class StructureController {
    ...
    @PutMapping("/members/{memberId}") public ResponseEntity<ProjectMemberDto> updateMember(@PathVariable Long memberId, @RequestParam(required = false) String role) { return ResponseEntity.ok(structureService.updateMember(memberId, role)); }
