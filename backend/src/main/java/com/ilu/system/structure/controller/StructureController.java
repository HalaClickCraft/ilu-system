...
public class StructureController {
    ...
    @PostMapping("/projects/{projectId}/members") public ResponseEntity<ProjectMemberDto> addMember(@PathVariable Long projectId, @RequestParam String employeeId, @RequestParam String employeeName, @RequestParam(required = false) String role, @RequestParam(required = false) String shift) { return ResponseEntity.status(HttpStatus.CREATED).body(structureService.addMember(projectId, employeeId, employeeName, role, shift)); }
    @PutMapping("/members/{memberId}") public ResponseEntity<ProjectMemberDto> updateMember(@PathVariable Long memberId, @RequestParam(required = false) String role, @RequestParam(required = false) String shift) { return ResponseEntity.ok(structureService.updateMember(memberId, role, shift)); }
