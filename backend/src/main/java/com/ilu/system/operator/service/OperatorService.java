...
public class OperatorService {
    ...
    public OperatorService(OperatorRepository operatorRepository, TeamRepository teamRepository, WorkstationFormationRepository workstationFormationRepository, FormationAssignmentRepository formationAssignmentRepository) {
