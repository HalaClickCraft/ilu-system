  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
          <div><p class="text-sm font-medium text-gray-500">Operateurs Formes HSE</p><p class="text-3xl font-bold text-emerald-600 mt-1">{{ hseCertified }}</p></div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between">
          <div><p class="text-sm font-medium text-gray-500">Total Operateurs</p><p class="text-3xl font-bold text-gray-900 mt-1">{{ totalOperators }}</p></div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 class="text-lg font-semibold text-gray-900 mb-4">Conformite par Equipe</h2>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
      ...
      <router-link to="/operators" class="flex items-center gap-3 p-4 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition group">
        ...
        <div><p class="text-sm font-medium text-gray-700">Liste Operateurs</p><p class="text-xs text-gray-400">Verifier les statuts</p></div>
      </router-link>
