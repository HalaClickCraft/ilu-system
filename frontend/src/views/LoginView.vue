    ...
    <div class="w-full max-w-md px-4">
      <div class="bg-white rounded-2xl shadow-2xl p-8">
        <div class="text-center mb-8">
          ...
          <h1 class="text-2xl font-bold text-gray-900">Système ILU</h1>
          <p class="text-gray-500 mt-1">Gestion de la Formation Industrielle</p>
        </div>
        <form @submit.prevent="handleLogin" class="space-y-5">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Identifiant employé</label>
          ...
          <button type="submit" :disabled="authStore.loading"
            class="w-full bg-sky-600 hover:bg-sky-700 disabled:bg-sky-400 text-white font-medium py-2.5 rounded-lg transition-colors">
