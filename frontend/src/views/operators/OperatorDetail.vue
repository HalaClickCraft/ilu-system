<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-3"><div class="w-12 h-12 rounded-full bg-emerald-500 flex items-center justify-center text-white font-bold text-lg">{{ (operator.lastName || '')[0] }}{{ (operator.firstName || '')[0] }}</div><h1 class="text-2xl font-bold text-gray-900">{{ operator.lastName }} {{ operator.firstName }}</h1></div>
